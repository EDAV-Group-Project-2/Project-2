...
setwd('/Users/tianhaolu/Documents/Columbia\ classes/STAT\ 4701/HW2')
flood=read.csv('GlobalFloodsRecord.csv')
names(flood)[30]='news'
...
p=p+scale_size('area')
p=p+annotate("text", label = "causes of world flood 2010-2015", x = 12, y = 100, size = 8, colour = "black")
p
```
